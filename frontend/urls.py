...
urlpatterns = patterns('',
	...
	url(r'^ediciones-impresas/$', 'frontend.views.impressed', name='impressed'),
	url(r'^vive-boyaca/$', 'frontend.views.vive_boyaca_home', name='vive_boyaca_home'),
	url(r'^vive-boyaca/(?P<slug>[-\w]+)/$', 'frontend.views.serve_town', name='serve_town'),
